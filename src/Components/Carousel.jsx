...
// Video for Mobile (Still included in case of future use or mobile-specific functionality)
...
const Carousel = ({ interval = 3000 }) => {
  ...
  // Mute/Unmute toggle (for mobile video usage in future)
  const toggleMute = () => {
    if (videoRef.current) {
  ...
  return (
    <div {...swipeHandlers} className="relative w-full overflow-hidden bg-gray-100 mt-16 sm:mt-24">
