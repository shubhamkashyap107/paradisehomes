  ...
  return (
    <div className="rounded-lg bg-gray-900 text-white p-8 mt-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        {/* Phone */}
        <div className="bg-gray-800 border border-gray-700 p-4 flex items-center space-x-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 sm:w-full sm:text-sm md:text-lg">
          <i className="fa-solid fa-phone text-blue-500 text-3xl"></i>
          <div>
            <p className="text-sm sm:text-base text-white font-semibold">+91 9811043593</p>
            <p className="text-sm sm:text-base text-white font-semibold">+91 9999800990</p>
          </div>
        </div>
        ...
        <div className="bg-gray-800 border border-gray-700 p-4 flex items-center space-x-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 sm:w-full sm:text-sm md:text-lg">
          ...
          <a
            ...
            className="text-sm sm:text-base text-white font-semibold transition-colors duration-200 hover:text-blue-500"
          >
